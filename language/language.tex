...
\begin{mathparpagebreakable}
  ...
  \and
  \inferH{T-int}{}{\typed{\ctx}{\Num{n}}{\Tnat}}
  \and
...
\begin{mathparpagebreakable}
  ...
  \and
  \inferH{E-if-true}{}{\reduces{\If \expr_1 then \expr_2\; \Else \expr_3}{\expr_2}}
  \and
  \inferH{E-if-false}{}{\reduces{\If \expr_1 then \expr_2\; \Else \expr_3}{\expr_3}}
  \and
  ...
  \and
  \inferH{E-match-inj1}{}{\reduces{\Match {(\Inj{1}\val_1)} with \Inj{1} \var => \expr_2 | \Inj{2} => \expr_3 end}{\subst{\expr_2}{\var}{\val_1}}}
  \and
  \inferH{E-match-inj2}{}{\reduces{\Match {(\Inj{2}\val_1)} with \Inj{1} \var => \expr_2 | \Inj{2} => \expr_3 end}{\subst{\expr_3}{\var}{\val_1}}}
  \and
  ...
  \and
  \inferH{E-app}{}{\reduces{(\Rec f \var :=  \expr)~\val_2}{\subst{\subst{\expr}{f}{\Rec f \var :=  \expr}}{\var}{\val_2}}}
\end{mathparpagebreakable}
...
\begin{mathparpagebreakable}
  ...
  \and
  \inferH{T-int}{}{\mltyped{\ctx}{\hctx}{\Num{n}}{\Tnat}}
  \and
  ...
  \and
  \inferH{T-store}{\mltyped{\ctx}{\hctx}{\expr_1}{\Tref{\typ}} \and \mltyped{\ctx}{\hctx}{\expr_2}{\typ}}{\mltyped{\ctx}{\hctx}{\expr_1 \gets \expr_2}{\Tunit}}
  \and
...
\begin{mathparpagebreakable}
  ...
  \and
  \inferH{E-match-inj1}{}{\mlreduces{\heap}{\Match {(\Inj{1}\val_1)} with \Inj{1} \var => \expr_2 | \Inj{2} => \expr_3 end}{\heap'}{\subst{\expr_2}{\var}{\val_1}}}
  \and
  \inferH{E-match-inj2}{}{\mlreduces{\heap}{\Match {(\Inj{2}\val_1)} with \Inj{1} \var => \expr_2 | \Inj{2} => \expr_3 end}{\heap'}{\subst{\expr_3}{\var}{\val_1}}}
  \and
  ...
  \and
  \inferH{E-store2}{\mlreduces{\heap}{\expr_2}{\heap'}{\expr_2'}}{\mlreduces{\heap}{\val_1 \gets \expr_2}{\heap'}{\val_1 \gets \expr_2'}}
  \and
